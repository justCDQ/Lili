...
- [JSON Schema 与运行时校验](../prompt/schema-in-prompt-workflow.md)。
- [统一模型 Client 与厂商隔离](../model-api/unified-model-client.md)。
- [AI 任务状态机](../ai-ux/01-ai-task-state-machine.md)。
- [Tool 权限、审计、脱敏与错误隔离](../tool-design/06-permission-audit-redaction-error-isolation.md)。
